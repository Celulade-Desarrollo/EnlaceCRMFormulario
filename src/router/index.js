...
const router = createRouter({
  ...
  routes: [
    {
      path: "/tratamientoDatosPersonales",
      name: "tratamientoDatosPersonales",
      component: () => import("../views/TratamientoDatosView.vue"),
    },
    {
      path: "/",
      name: "inicio",
    ...
    },
    {
      path: "/Pantalla17View",
      name: "cliente",
      component: () => import("../views/Pantalla17View.vue"),
    },
